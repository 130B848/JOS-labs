...
umain(int argc, char **argv)
{
  ...
  800050:	50                   	push   %eax
  800051:	68 20 14 80 00       	push   $0x801420
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001c3:	e8 e8 10 00 00       	call   8012b0 <__umoddi3>
  8001c8:	83 c4 14             	add    $0x14,%esp
  8001cb:	0f be 80 38 14 80 00 	movsbl 0x801438(%eax),%eax
  8001d2:	50                   	push   %eax
  ...
  8002a5:	e8 06 10 00 00       	call   8012b0 <__umoddi3>
  8002aa:	83 c4 14             	add    $0x14,%esp
  8002ad:	0f be 80 38 14 80 00 	movsbl 0x801438(%eax),%eax
  8002b4:	50                   	push   %eax
  ...
  8002db:	e8 a0 0e 00 00       	call   801180 <__udivdi3>
  ...
  800301:	e8 aa 0f 00 00       	call   8012b0 <__umoddi3>
  800306:	83 c4 14             	add    $0x14,%esp
  800309:	0f be 80 38 14 80 00 	movsbl 0x801438(%eax),%eax
  800310:	50                   	push   %eax
  ...
  800337:	e8 44 0e 00 00       	call   801180 <__udivdi3>
  ...
  80035d:	e8 4e 0f 00 00       	call   8012b0 <__umoddi3>
  800362:	83 c4 14             	add    $0x14,%esp
  800365:	0f be 80 38 14 80 00 	movsbl 0x801438(%eax),%eax
  80036c:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800480:	ff 24 85 80 15 80 00 	jmp    *0x801580(,%eax,4)
  ...
  800566:	8b 14 85 e0 16 80 00 	mov    0x8016e0(,%eax,4),%edx
  80056d:	85 d2                	test   %edx,%edx
  80056f:	75 15                	jne    800586 <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  800571:	50                   	push   %eax
  800572:	68 50 14 80 00       	push   $0x801450
  800577:	53                   	push   %ebx
  800578:	57                   	push   %edi
  ...
  800586:	52                   	push   %edx
  800587:	68 59 14 80 00       	push   $0x801459
  80058c:	53                   	push   %ebx
  80058d:	57                   	push   %edi
  ...
  8005a8:	b9 49 14 80 00       	mov    $0x801449,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  800824:	68 f0 14 80 00       	push   $0x8014f0
  800829:	68 59 14 80 00       	push   $0x801459
  ...
  800845:	68 28 15 80 00       	push   $0x801528
  80084a:	68 59 14 80 00       	push   $0x801459
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800de1:	8d 35 e9 0d 80 00    	lea    0x800de9,%esi
  800de7:	0f 34                	sysenter 
...
00800de9 <label_90>:
  ...
  800df3:	7e 17                	jle    800e0c <label_90+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800df5:	83 ec 0c             	sub    $0xc,%esp
  800df8:	50                   	push   %eax
  800df9:	6a 03                	push   $0x3
  800dfb:	68 04 17 80 00       	push   $0x801704
  800e00:	6a 29                	push   $0x29
  800e02:	68 21 17 80 00       	push   $0x801721
  800e07:	e8 06 03 00 00       	call   801112 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e94:	8d 35 9c 0e 80 00    	lea    0x800e9c,%esi
  800e9a:	0f 34                	sysenter 
...
00800ed0 <label_244>:
  ...
  800eda:	7e 17                	jle    800ef3 <label_244+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800edc:	83 ec 0c             	sub    $0xc,%esp
  800edf:	50                   	push   %eax
  800ee0:	6a 05                	push   $0x5
  800ee2:	68 04 17 80 00       	push   $0x801704
  800ee7:	6a 29                	push   $0x29
  800ee9:	68 21 17 80 00       	push   $0x801721
  800eee:	e8 1f 02 00 00       	call   801112 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800f0b:	89 45 e8             	mov    %eax,-0x18(%ebp)
  ...
  800f1a:	8b 45 18             	mov    0x18(%ebp),%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800f20:	8d 55 e4             	lea    -0x1c(%ebp),%edx
...
00800f41 <label_304>:
  ...
  800f4b:	7e 17                	jle    800f64 <label_304+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800f4d:	83 ec 0c             	sub    $0xc,%esp
  800f50:	50                   	push   %eax
  800f51:	6a 06                	push   $0x6
  800f53:	68 04 17 80 00       	push   $0x801704
  800f58:	6a 29                	push   $0x29
  800f5a:	68 21 17 80 00       	push   $0x801721
  800f5f:	e8 ae 01 00 00       	call   801112 <_panic>
	args[1] = (uint32_t) srcva;
	args[2] = (uint32_t) dstenv;
	args[3] = (uint32_t) dstva;
	args[4] = (uint32_t) perm;
...
00800f92 <label_353>:
  ...
  800f9c:	7e 17                	jle    800fb5 <label_353+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800f9e:	83 ec 0c             	sub    $0xc,%esp
  800fa1:	50                   	push   %eax
  800fa2:	6a 07                	push   $0x7
  800fa4:	68 04 17 80 00       	push   $0x801704
  800fa9:	6a 29                	push   $0x29
  800fab:	68 21 17 80 00       	push   $0x801721
  800fb0:	e8 5d 01 00 00       	call   801112 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800fb5:	8d 65 f8             	lea    -0x8(%ebp),%esp
  800fb8:	5b                   	pop    %ebx
  800fb9:	5f                   	pop    %edi
  800fba:	5d                   	pop    %ebp
  800fbb:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800fc6:	b8 09 00 00 00       	mov    $0x9,%eax
...
00800fe3 <label_402>:
  ...
  800fed:	7e 17                	jle    801006 <label_402+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800fef:	83 ec 0c             	sub    $0xc,%esp
  800ff2:	50                   	push   %eax
  800ff3:	6a 09                	push   $0x9
  800ff5:	68 04 17 80 00       	push   $0x801704
  800ffa:	6a 29                	push   $0x29
  800ffc:	68 21 17 80 00       	push   $0x801721
  801001:	e8 0c 01 00 00       	call   801112 <_panic>
...
0080100d <sys_env_set_pgfault_upcall>:
...
00801034 <label_451>:
  ...
  80103e:	7e 17                	jle    801057 <label_451+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  801040:	83 ec 0c             	sub    $0xc,%esp
  801043:	50                   	push   %eax
  801044:	6a 0a                	push   $0xa
  801046:	68 04 17 80 00       	push   $0x801704
  80104b:	6a 29                	push   $0x29
  80104d:	68 21 17 80 00       	push   $0x801721
  801052:	e8 bb 00 00 00       	call   801112 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801057:	8d 65 f8             	lea    -0x8(%ebp),%esp
  80105a:	5b                   	pop    %ebx
  80105b:	5f                   	pop    %edi
  80105c:	5d                   	pop    %ebp
  80105d:	c3                   	ret    
...
008010b6 <label_537>:
  ...
  8010c0:	7e 17                	jle    8010d9 <label_537+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  8010c2:	83 ec 0c             	sub    $0xc,%esp
  8010c5:	50                   	push   %eax
  8010c6:	6a 0d                	push   $0xd
  8010c8:	68 04 17 80 00       	push   $0x801704
  8010cd:	6a 29                	push   $0x29
  8010cf:	68 21 17 80 00       	push   $0x801721
  8010d4:	e8 39 00 00 00       	call   801112 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801116:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  801117:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	if (argv0)
  80111a:	a1 14 20 80 00       	mov    0x802014,%eax
  80111f:	85 c0                	test   %eax,%eax
  801121:	74 11                	je     801134 <_panic+0x22>
		cprintf("%s: ", argv0);
  801123:	83 ec 08             	sub    $0x8,%esp
  801126:	50                   	push   %eax
  801127:	68 2f 17 80 00       	push   $0x80172f
  80112c:	e8 1a f0 ff ff       	call   80014b <cprintf>
  801131:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  801134:	8b 35 00 20 80 00    	mov    0x802000,%esi
  80113a:	e8 d4 fc ff ff       	call   800e13 <sys_getenvid>
  80113f:	83 ec 0c             	sub    $0xc,%esp
  801142:	ff 75 0c             	pushl  0xc(%ebp)
  801145:	ff 75 08             	pushl  0x8(%ebp)
  801148:	56                   	push   %esi
  801149:	50                   	push   %eax
  80114a:	68 34 17 80 00       	push   $0x801734
  80114f:	e8 f7 ef ff ff       	call   80014b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801154:	83 c4 18             	add    $0x18,%esp
  801157:	53                   	push   %ebx
  801158:	ff 75 10             	pushl  0x10(%ebp)
  80115b:	e8 9a ef ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  801160:	c7 04 24 2c 14 80 00 	movl   $0x80142c,(%esp)
  801167:	e8 df ef ff ff       	call   80014b <cprintf>
  80116c:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  80116f:	cc                   	int3   
  801170:	eb fd                	jmp    80116f <_panic+0x5d>
