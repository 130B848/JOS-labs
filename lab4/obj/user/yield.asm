...
umain(int argc, char **argv)
{
  ...
  800042:	50                   	push   %eax
  800043:	68 40 14 80 00       	push   $0x801440
  ...
  800065:	53                   	push   %ebx
  800066:	50                   	push   %eax
  800067:	68 60 14 80 00       	push   $0x801460
...
umain(int argc, char **argv)
{
  ...
  800087:	50                   	push   %eax
  800088:	68 8c 14 80 00       	push   $0x80148c
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001fd:	e8 de 10 00 00       	call   8012e0 <__umoddi3>
  800202:	83 c4 14             	add    $0x14,%esp
  800205:	0f be 80 b5 14 80 00 	movsbl 0x8014b5(%eax),%eax
  80020c:	50                   	push   %eax
  ...
  8002df:	e8 fc 0f 00 00       	call   8012e0 <__umoddi3>
  8002e4:	83 c4 14             	add    $0x14,%esp
  8002e7:	0f be 80 b5 14 80 00 	movsbl 0x8014b5(%eax),%eax
  8002ee:	50                   	push   %eax
  ...
  800315:	e8 96 0e 00 00       	call   8011b0 <__udivdi3>
  ...
  80033b:	e8 a0 0f 00 00       	call   8012e0 <__umoddi3>
  800340:	83 c4 14             	add    $0x14,%esp
  800343:	0f be 80 b5 14 80 00 	movsbl 0x8014b5(%eax),%eax
  80034a:	50                   	push   %eax
  ...
  800371:	e8 3a 0e 00 00       	call   8011b0 <__udivdi3>
  ...
  800397:	e8 44 0f 00 00       	call   8012e0 <__umoddi3>
  80039c:	83 c4 14             	add    $0x14,%esp
  80039f:	0f be 80 b5 14 80 00 	movsbl 0x8014b5(%eax),%eax
  8003a6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004ba:	ff 24 85 00 16 80 00 	jmp    *0x801600(,%eax,4)
  ...
  8005a0:	8b 14 85 60 17 80 00 	mov    0x801760(,%eax,4),%edx
  8005a7:	85 d2                	test   %edx,%edx
  8005a9:	75 15                	jne    8005c0 <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  8005ab:	50                   	push   %eax
  8005ac:	68 cd 14 80 00       	push   $0x8014cd
  8005b1:	53                   	push   %ebx
  8005b2:	57                   	push   %edi
  ...
  8005c0:	52                   	push   %edx
  8005c1:	68 d6 14 80 00       	push   $0x8014d6
  8005c6:	53                   	push   %ebx
  8005c7:	57                   	push   %edi
  ...
  8005e2:	b9 c6 14 80 00       	mov    $0x8014c6,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  80085e:	68 6c 15 80 00       	push   $0x80156c
  800863:	68 d6 14 80 00       	push   $0x8014d6
  ...
  80087f:	68 a4 15 80 00       	push   $0x8015a4
  800884:	68 d6 14 80 00       	push   $0x8014d6
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800db8:	8d 35 c0 0d 80 00    	lea    0x800dc0,%esi
  800dbe:	0f 34                	sysenter 
...
00800e23 <label_90>:
  ...
  800e2d:	7e 17                	jle    800e46 <label_90+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800e2f:	83 ec 0c             	sub    $0xc,%esp
  800e32:	50                   	push   %eax
  800e33:	6a 03                	push   $0x3
  800e35:	68 84 17 80 00       	push   $0x801784
  800e3a:	6a 29                	push   $0x29
  800e3c:	68 a1 17 80 00       	push   $0x8017a1
  800e41:	e8 06 03 00 00       	call   80114c <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e6a:	8d 35 72 0e 80 00    	lea    0x800e72,%esi
  800e70:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e9d:	8d 35 a5 0e 80 00    	lea    0x800ea5,%esi
  800ea3:	0f 34                	sysenter 
...
00800f0a <label_244>:
  ...
  800f14:	7e 17                	jle    800f2d <label_244+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800f16:	83 ec 0c             	sub    $0xc,%esp
  800f19:	50                   	push   %eax
  800f1a:	6a 05                	push   $0x5
  800f1c:	68 84 17 80 00       	push   $0x801784
  800f21:	6a 29                	push   $0x29
  800f23:	68 a1 17 80 00       	push   $0x8017a1
  800f28:	e8 1f 02 00 00       	call   80114c <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800f5a:	8d 55 e4             	lea    -0x1c(%ebp),%edx
...
00800f7b <label_304>:
  ...
  800f85:	7e 17                	jle    800f9e <label_304+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800f87:	83 ec 0c             	sub    $0xc,%esp
  800f8a:	50                   	push   %eax
  800f8b:	6a 06                	push   $0x6
  800f8d:	68 84 17 80 00       	push   $0x801784
  800f92:	6a 29                	push   $0x29
  800f94:	68 a1 17 80 00       	push   $0x8017a1
  800f99:	e8 ae 01 00 00       	call   80114c <_panic>
	args[1] = (uint32_t) srcva;
	args[2] = (uint32_t) dstenv;
	args[3] = (uint32_t) dstva;
	args[4] = (uint32_t) perm;
...
00800fcc <label_353>:
  ...
  800fd6:	7e 17                	jle    800fef <label_353+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800fd8:	83 ec 0c             	sub    $0xc,%esp
  800fdb:	50                   	push   %eax
  800fdc:	6a 07                	push   $0x7
  800fde:	68 84 17 80 00       	push   $0x801784
  800fe3:	6a 29                	push   $0x29
  800fe5:	68 a1 17 80 00       	push   $0x8017a1
  800fea:	e8 5d 01 00 00       	call   80114c <_panic>
...
0080101d <label_402>:
  ...
  801027:	7e 17                	jle    801040 <label_402+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  801029:	83 ec 0c             	sub    $0xc,%esp
  80102c:	50                   	push   %eax
  80102d:	6a 09                	push   $0x9
  80102f:	68 84 17 80 00       	push   $0x801784
  801034:	6a 29                	push   $0x29
  801036:	68 a1 17 80 00       	push   $0x8017a1
  80103b:	e8 0c 01 00 00       	call   80114c <_panic>
...
00801047 <sys_env_set_pgfault_upcall>:
...
0080106e <label_451>:
  ...
  801078:	7e 17                	jle    801091 <label_451+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  80107a:	83 ec 0c             	sub    $0xc,%esp
  80107d:	50                   	push   %eax
  80107e:	6a 0a                	push   $0xa
  801080:	68 84 17 80 00       	push   $0x801784
  801085:	6a 29                	push   $0x29
  801087:	68 a1 17 80 00       	push   $0x8017a1
  80108c:	e8 bb 00 00 00       	call   80114c <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80109d:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  8010b6:	8d 35 be 10 80 00    	lea    0x8010be,%esi
  8010bc:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010d4:	b8 0d 00 00 00       	mov    $0xd,%eax
  8010d9:	8b 55 08             	mov    0x8(%ebp),%edx
  8010dc:	89 d9                	mov    %ebx,%ecx
...
008010f0 <label_537>:
  ...
  8010fa:	7e 17                	jle    801113 <label_537+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  8010fc:	83 ec 0c             	sub    $0xc,%esp
  8010ff:	50                   	push   %eax
  801100:	6a 0d                	push   $0xd
  801102:	68 84 17 80 00       	push   $0x801784
  801107:	6a 29                	push   $0x29
  801109:	68 a1 17 80 00       	push   $0x8017a1
  80110e:	e8 39 00 00 00       	call   80114c <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801124:	b8 0e 00 00 00       	mov    $0xe,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801150:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  801151:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	if (argv0)
  801154:	a1 10 20 80 00       	mov    0x802010,%eax
  801159:	85 c0                	test   %eax,%eax
  80115b:	74 11                	je     80116e <_panic+0x22>
		cprintf("%s: ", argv0);
  80115d:	83 ec 08             	sub    $0x8,%esp
  801160:	50                   	push   %eax
  801161:	68 af 17 80 00       	push   $0x8017af
  801166:	e8 1a f0 ff ff       	call   800185 <cprintf>
  80116b:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80116e:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801174:	e8 d4 fc ff ff       	call   800e4d <sys_getenvid>
  801179:	83 ec 0c             	sub    $0xc,%esp
  80117c:	ff 75 0c             	pushl  0xc(%ebp)
  80117f:	ff 75 08             	pushl  0x8(%ebp)
  801182:	56                   	push   %esi
  801183:	50                   	push   %eax
  801184:	68 b8 17 80 00       	push   $0x8017b8
  801189:	e8 f7 ef ff ff       	call   800185 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80118e:	83 c4 18             	add    $0x18,%esp
  801191:	53                   	push   %ebx
  801192:	ff 75 10             	pushl  0x10(%ebp)
  801195:	e8 9a ef ff ff       	call   800134 <vcprintf>
	cprintf("\n");
  80119a:	c7 04 24 b4 17 80 00 	movl   $0x8017b4,(%esp)
  8011a1:	e8 df ef ff ff       	call   800185 <cprintf>
  8011a6:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  8011a9:	cc                   	int3   
  8011aa:	eb fd                	jmp    8011a9 <_panic+0x5d>
