...
umain(int argc, char **argv)
{
  ...
  800042:	68 00 14 80 00       	push   $0x801400
  ...
  80006a:	68 28 14 80 00       	push   $0x801428
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001dc:	e8 bf 10 00 00       	call   8012a0 <__umoddi3>
  8001e1:	83 c4 14             	add    $0x14,%esp
  8001e4:	0f be 80 49 14 80 00 	movsbl 0x801449(%eax),%eax
  8001eb:	50                   	push   %eax
  ...
  8002be:	e8 dd 0f 00 00       	call   8012a0 <__umoddi3>
  8002c3:	83 c4 14             	add    $0x14,%esp
  8002c6:	0f be 80 49 14 80 00 	movsbl 0x801449(%eax),%eax
  8002cd:	50                   	push   %eax
  ...
  8002f4:	e8 77 0e 00 00       	call   801170 <__udivdi3>
  ...
  80031a:	e8 81 0f 00 00       	call   8012a0 <__umoddi3>
  80031f:	83 c4 14             	add    $0x14,%esp
  800322:	0f be 80 49 14 80 00 	movsbl 0x801449(%eax),%eax
  800329:	50                   	push   %eax
  ...
  800350:	e8 1b 0e 00 00       	call   801170 <__udivdi3>
  ...
  800376:	e8 25 0f 00 00       	call   8012a0 <__umoddi3>
  80037b:	83 c4 14             	add    $0x14,%esp
  80037e:	0f be 80 49 14 80 00 	movsbl 0x801449(%eax),%eax
  800385:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800499:	ff 24 85 80 15 80 00 	jmp    *0x801580(,%eax,4)
  ...
  80057f:	8b 14 85 e0 16 80 00 	mov    0x8016e0(,%eax,4),%edx
  800586:	85 d2                	test   %edx,%edx
  800588:	75 15                	jne    80059f <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  80058a:	50                   	push   %eax
  80058b:	68 61 14 80 00       	push   $0x801461
  800590:	53                   	push   %ebx
  800591:	57                   	push   %edi
  ...
  80059f:	52                   	push   %edx
  8005a0:	68 6a 14 80 00       	push   $0x80146a
  8005a5:	53                   	push   %ebx
  8005a6:	57                   	push   %edi
  ...
  8005c1:	b9 5a 14 80 00       	mov    $0x80145a,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  80083d:	68 00 15 80 00       	push   $0x801500
  800842:	68 6a 14 80 00       	push   $0x80146a
  ...
  80085e:	68 38 15 80 00       	push   $0x801538
  800863:	68 6a 14 80 00       	push   $0x80146a
...
00800e03 <label_90>:
  ...
  800e14:	68 04 17 80 00       	push   $0x801704
  800e19:	6a 2a                	push   $0x2a
  800e1b:	68 21 17 80 00       	push   $0x801721
  800e20:	e8 e5 02 00 00       	call   80110a <_panic>
...
00800eea <label_244>:
  ...
  800ef3:	7e 17                	jle    800f0c <label_244+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800ef5:	83 ec 0c             	sub    $0xc,%esp
  800ef8:	50                   	push   %eax
  800ef9:	6a 05                	push   $0x5
  800efb:	68 04 17 80 00       	push   $0x801704
  800f00:	6a 2a                	push   $0x2a
  800f02:	68 21 17 80 00       	push   $0x801721
  800f07:	e8 fe 01 00 00       	call   80110a <_panic>
...
00800f3a <label_295>:
  ...
  800f43:	7e 17                	jle    800f5c <label_295+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800f45:	83 ec 0c             	sub    $0xc,%esp
  800f48:	50                   	push   %eax
  800f49:	6a 06                	push   $0x6
  800f4b:	68 04 17 80 00       	push   $0x801704
  800f50:	6a 2a                	push   $0x2a
  800f52:	68 21 17 80 00       	push   $0x801721
  800f57:	e8 ae 01 00 00       	call   80110a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f83:	8d 35 8b 0f 80 00    	lea    0x800f8b,%esi
  800f89:	0f 34                	sysenter 
...
00800f8b <label_344>:
  ...
  800f94:	7e 17                	jle    800fad <label_344+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800f96:	83 ec 0c             	sub    $0xc,%esp
  800f99:	50                   	push   %eax
  800f9a:	6a 07                	push   $0x7
  800f9c:	68 04 17 80 00       	push   $0x801704
  800fa1:	6a 2a                	push   $0x2a
  800fa3:	68 21 17 80 00       	push   $0x801721
  800fa8:	e8 5d 01 00 00       	call   80110a <_panic>
...
00800fdc <label_393>:
  ...
  800fe5:	7e 17                	jle    800ffe <label_393+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800fe7:	83 ec 0c             	sub    $0xc,%esp
  800fea:	50                   	push   %eax
  800feb:	6a 09                	push   $0x9
  800fed:	68 04 17 80 00       	push   $0x801704
  800ff2:	6a 2a                	push   $0x2a
  800ff4:	68 21 17 80 00       	push   $0x801721
  800ff9:	e8 0c 01 00 00       	call   80110a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801025:	8d 35 2d 10 80 00    	lea    0x80102d,%esi
  80102b:	0f 34                	sysenter 
...
0080102d <label_442>:
  ...
  801036:	7e 17                	jle    80104f <label_442+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  801038:	83 ec 0c             	sub    $0xc,%esp
  80103b:	50                   	push   %eax
  80103c:	6a 0a                	push   $0xa
  80103e:	68 04 17 80 00       	push   $0x801704
  801043:	6a 2a                	push   $0x2a
  801045:	68 21 17 80 00       	push   $0x801721
  80104a:	e8 bb 00 00 00       	call   80110a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80105b:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  801075:	8d 35 7d 10 80 00    	lea    0x80107d,%esi
  80107b:	0f 34                	sysenter 
...
008010af <label_528>:
  ...
  8010b8:	7e 17                	jle    8010d1 <label_528+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  8010ba:	83 ec 0c             	sub    $0xc,%esp
  8010bd:	50                   	push   %eax
  8010be:	6a 0d                	push   $0xd
  8010c0:	68 04 17 80 00       	push   $0x801704
  8010c5:	6a 2a                	push   $0x2a
  8010c7:	68 21 17 80 00       	push   $0x801721
  8010cc:	e8 39 00 00 00       	call   80110a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010e2:	b8 0e 00 00 00       	mov    $0xe,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80110e:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  80110f:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	if (argv0)
  801112:	a1 10 20 80 00       	mov    0x802010,%eax
  801117:	85 c0                	test   %eax,%eax
  801119:	74 11                	je     80112c <_panic+0x22>
		cprintf("%s: ", argv0);
  80111b:	83 ec 08             	sub    $0x8,%esp
  80111e:	50                   	push   %eax
  80111f:	68 2f 17 80 00       	push   $0x80172f
  801124:	e8 3b f0 ff ff       	call   800164 <cprintf>
  801129:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80112c:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801132:	e8 f5 fc ff ff       	call   800e2c <sys_getenvid>
  801137:	83 ec 0c             	sub    $0xc,%esp
  80113a:	ff 75 0c             	pushl  0xc(%ebp)
  80113d:	ff 75 08             	pushl  0x8(%ebp)
  801140:	56                   	push   %esi
  801141:	50                   	push   %eax
  801142:	68 34 17 80 00       	push   $0x801734
  801147:	e8 18 f0 ff ff       	call   800164 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80114c:	83 c4 18             	add    $0x18,%esp
  80114f:	53                   	push   %ebx
  801150:	ff 75 10             	pushl  0x10(%ebp)
  801153:	e8 bb ef ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  801158:	c7 04 24 16 14 80 00 	movl   $0x801416,(%esp)
  80115f:	e8 00 f0 ff ff       	call   800164 <cprintf>
  801164:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  801167:	cc                   	int3   
  801168:	eb fd                	jmp    801167 <_panic+0x5d>
