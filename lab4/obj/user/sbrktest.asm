...
umain(int argc, char **argv)
{
  ...
  800062:	68 40 14 80 00       	push   $0x801440
  ...
  8000a3:	56                   	push   %esi
  8000a4:	68 60 14 80 00       	push   $0x801460
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021c:	e8 bf 10 00 00       	call   8012e0 <__umoddi3>
  800221:	83 c4 14             	add    $0x14,%esp
  800224:	0f be 80 79 14 80 00 	movsbl 0x801479(%eax),%eax
  80022b:	50                   	push   %eax
  ...
  8002fe:	e8 dd 0f 00 00       	call   8012e0 <__umoddi3>
  800303:	83 c4 14             	add    $0x14,%esp
  800306:	0f be 80 79 14 80 00 	movsbl 0x801479(%eax),%eax
  80030d:	50                   	push   %eax
  ...
  800334:	e8 77 0e 00 00       	call   8011b0 <__udivdi3>
  ...
  80035a:	e8 81 0f 00 00       	call   8012e0 <__umoddi3>
  80035f:	83 c4 14             	add    $0x14,%esp
  800362:	0f be 80 79 14 80 00 	movsbl 0x801479(%eax),%eax
  800369:	50                   	push   %eax
  ...
  800390:	e8 1b 0e 00 00       	call   8011b0 <__udivdi3>
  ...
  8003b6:	e8 25 0f 00 00       	call   8012e0 <__umoddi3>
  8003bb:	83 c4 14             	add    $0x14,%esp
  8003be:	0f be 80 79 14 80 00 	movsbl 0x801479(%eax),%eax
  8003c5:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004d9:	ff 24 85 c0 15 80 00 	jmp    *0x8015c0(,%eax,4)
  ...
  8005bf:	8b 14 85 20 17 80 00 	mov    0x801720(,%eax,4),%edx
  8005c6:	85 d2                	test   %edx,%edx
  8005c8:	75 15                	jne    8005df <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  8005ca:	50                   	push   %eax
  8005cb:	68 91 14 80 00       	push   $0x801491
  8005d0:	53                   	push   %ebx
  8005d1:	57                   	push   %edi
  ...
  8005df:	52                   	push   %edx
  8005e0:	68 9a 14 80 00       	push   $0x80149a
  8005e5:	53                   	push   %ebx
  8005e6:	57                   	push   %edi
  ...
  800601:	b9 8a 14 80 00       	mov    $0x80148a,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  80087d:	68 30 15 80 00       	push   $0x801530
  800882:	68 9a 14 80 00       	push   $0x80149a
  ...
  80089e:	68 68 15 80 00       	push   $0x801568
  8008a3:	68 9a 14 80 00       	push   $0x80149a
...
00800e43 <label_90>:
  ...
  800e54:	68 44 17 80 00       	push   $0x801744
  800e59:	6a 2a                	push   $0x2a
  800e5b:	68 61 17 80 00       	push   $0x801761
  800e60:	e8 e5 02 00 00       	call   80114a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800eee:	8d 35 f6 0e 80 00    	lea    0x800ef6,%esi
...
00800f2a <label_244>:
  ...
  800f33:	7e 17                	jle    800f4c <label_244+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800f35:	83 ec 0c             	sub    $0xc,%esp
  800f38:	50                   	push   %eax
  800f39:	6a 05                	push   $0x5
  800f3b:	68 44 17 80 00       	push   $0x801744
  800f40:	6a 2a                	push   $0x2a
  800f42:	68 61 17 80 00       	push   $0x801761
  800f47:	e8 fe 01 00 00       	call   80114a <_panic>
...
00800f7a <label_295>:
  ...
  800f83:	7e 17                	jle    800f9c <label_295+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800f85:	83 ec 0c             	sub    $0xc,%esp
  800f88:	50                   	push   %eax
  800f89:	6a 06                	push   $0x6
  800f8b:	68 44 17 80 00       	push   $0x801744
  800f90:	6a 2a                	push   $0x2a
  800f92:	68 61 17 80 00       	push   $0x801761
  800f97:	e8 ae 01 00 00       	call   80114a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800fc3:	8d 35 cb 0f 80 00    	lea    0x800fcb,%esi
  800fc9:	0f 34                	sysenter 
...
00800fcb <label_344>:
  ...
  800fd4:	7e 17                	jle    800fed <label_344+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800fd6:	83 ec 0c             	sub    $0xc,%esp
  800fd9:	50                   	push   %eax
  800fda:	6a 07                	push   $0x7
  800fdc:	68 44 17 80 00       	push   $0x801744
  800fe1:	6a 2a                	push   $0x2a
  800fe3:	68 61 17 80 00       	push   $0x801761
  800fe8:	e8 5d 01 00 00       	call   80114a <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800fed:	8d 65 f8             	lea    -0x8(%ebp),%esp
  800ff0:	5b                   	pop    %ebx
  800ff1:	5f                   	pop    %edi
  800ff2:	5d                   	pop    %ebp
  800ff3:	c3                   	ret    
...
0080101c <label_393>:
  ...
  801025:	7e 17                	jle    80103e <label_393+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  801027:	83 ec 0c             	sub    $0xc,%esp
  80102a:	50                   	push   %eax
  80102b:	6a 09                	push   $0x9
  80102d:	68 44 17 80 00       	push   $0x801744
  801032:	6a 2a                	push   $0x2a
  801034:	68 61 17 80 00       	push   $0x801761
  801039:	e8 0c 01 00 00       	call   80114a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801065:	8d 35 6d 10 80 00    	lea    0x80106d,%esi
  80106b:	0f 34                	sysenter 
...
0080106d <label_442>:
  ...
  801076:	7e 17                	jle    80108f <label_442+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  801078:	83 ec 0c             	sub    $0xc,%esp
  80107b:	50                   	push   %eax
  80107c:	6a 0a                	push   $0xa
  80107e:	68 44 17 80 00       	push   $0x801744
  801083:	6a 2a                	push   $0x2a
  801085:	68 61 17 80 00       	push   $0x801761
  80108a:	e8 bb 00 00 00       	call   80114a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010d2:	b8 0d 00 00 00       	mov    $0xd,%eax
  8010d7:	8b 55 08             	mov    0x8(%ebp),%edx
  8010da:	89 d9                	mov    %ebx,%ecx
...
008010ef <label_528>:
  ...
  8010f8:	7e 17                	jle    801111 <label_528+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  8010fa:	83 ec 0c             	sub    $0xc,%esp
  8010fd:	50                   	push   %eax
  8010fe:	6a 0d                	push   $0xd
  801100:	68 44 17 80 00       	push   $0x801744
  801105:	6a 2a                	push   $0x2a
  801107:	68 61 17 80 00       	push   $0x801761
  80110c:	e8 39 00 00 00       	call   80114a <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801137:	8d 35 3f 11 80 00    	lea    0x80113f,%esi
  80113d:	0f 34                	sysenter 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80114e:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  80114f:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	if (argv0)
  801152:	a1 10 20 80 00       	mov    0x802010,%eax
  801157:	85 c0                	test   %eax,%eax
  801159:	74 11                	je     80116c <_panic+0x22>
		cprintf("%s: ", argv0);
  80115b:	83 ec 08             	sub    $0x8,%esp
  80115e:	50                   	push   %eax
  80115f:	68 6f 17 80 00       	push   $0x80176f
  801164:	e8 3b f0 ff ff       	call   8001a4 <cprintf>
  801169:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80116c:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801172:	e8 f5 fc ff ff       	call   800e6c <sys_getenvid>
  801177:	83 ec 0c             	sub    $0xc,%esp
  80117a:	ff 75 0c             	pushl  0xc(%ebp)
  80117d:	ff 75 08             	pushl  0x8(%ebp)
  801180:	56                   	push   %esi
  801181:	50                   	push   %eax
  801182:	68 74 17 80 00       	push   $0x801774
  801187:	e8 18 f0 ff ff       	call   8001a4 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80118c:	83 c4 18             	add    $0x18,%esp
  80118f:	53                   	push   %ebx
  801190:	ff 75 10             	pushl  0x10(%ebp)
  801193:	e8 bb ef ff ff       	call   800153 <vcprintf>
	cprintf("\n");
  801198:	c7 04 24 6d 14 80 00 	movl   $0x80146d,(%esp)
  80119f:	e8 00 f0 ff ff       	call   8001a4 <cprintf>
  8011a4:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  8011a7:	cc                   	int3   
  8011a8:	eb fd                	jmp    8011a7 <_panic+0x5d>
