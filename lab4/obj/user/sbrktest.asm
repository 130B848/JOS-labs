...
umain(int argc, char **argv)
{
  ...
  800062:	68 60 14 80 00       	push   $0x801460
  ...
  8000a3:	56                   	push   %esi
  8000a4:	68 80 14 80 00       	push   $0x801480
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021c:	e8 df 10 00 00       	call   801300 <__umoddi3>
  800221:	83 c4 14             	add    $0x14,%esp
  800224:	0f be 80 99 14 80 00 	movsbl 0x801499(%eax),%eax
  80022b:	50                   	push   %eax
  ...
  8002fe:	e8 fd 0f 00 00       	call   801300 <__umoddi3>
  800303:	83 c4 14             	add    $0x14,%esp
  800306:	0f be 80 99 14 80 00 	movsbl 0x801499(%eax),%eax
  80030d:	50                   	push   %eax
  ...
  800334:	e8 97 0e 00 00       	call   8011d0 <__udivdi3>
  ...
  80035a:	e8 a1 0f 00 00       	call   801300 <__umoddi3>
  80035f:	83 c4 14             	add    $0x14,%esp
  800362:	0f be 80 99 14 80 00 	movsbl 0x801499(%eax),%eax
  800369:	50                   	push   %eax
  ...
  800390:	e8 3b 0e 00 00       	call   8011d0 <__udivdi3>
  ...
  8003b6:	e8 45 0f 00 00       	call   801300 <__umoddi3>
  8003bb:	83 c4 14             	add    $0x14,%esp
  8003be:	0f be 80 99 14 80 00 	movsbl 0x801499(%eax),%eax
  8003c5:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004d9:	ff 24 85 e0 15 80 00 	jmp    *0x8015e0(,%eax,4)
  ...
  8005ba:	83 f8 08             	cmp    $0x8,%eax
  8005bd:	7f 0b                	jg     8005ca <vprintfmt+0x183>
  8005bf:	8b 14 85 40 17 80 00 	mov    0x801740(,%eax,4),%edx
  8005c6:	85 d2                	test   %edx,%edx
  8005c8:	75 15                	jne    8005df <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  8005ca:	50                   	push   %eax
  8005cb:	68 b1 14 80 00       	push   $0x8014b1
  8005d0:	53                   	push   %ebx
  8005d1:	57                   	push   %edi
  ...
  8005df:	52                   	push   %edx
  8005e0:	68 ba 14 80 00       	push   $0x8014ba
  8005e5:	53                   	push   %ebx
  8005e6:	57                   	push   %edi
  ...
  800601:	b9 aa 14 80 00       	mov    $0x8014aa,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  80087d:	68 50 15 80 00       	push   $0x801550
  800882:	68 ba 14 80 00       	push   $0x8014ba
  ...
  80089e:	68 88 15 80 00       	push   $0x801588
  8008a3:	68 ba 14 80 00       	push   $0x8014ba
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800dd7:	8d 35 df 0d 80 00    	lea    0x800ddf,%esi
  800ddd:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e08:	8d 35 10 0e 80 00    	lea    0x800e10,%esi
  800e0e:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e3a:	8d 35 42 0e 80 00    	lea    0x800e42,%esi
  800e40:	0f 34                	sysenter 
...
00800e42 <label_90>:
  ...
  800e4c:	7e 17                	jle    800e65 <label_90+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800e4e:	83 ec 0c             	sub    $0xc,%esp
  800e51:	50                   	push   %eax
  800e52:	6a 03                	push   $0x3
  800e54:	68 64 17 80 00       	push   $0x801764
  800e59:	6a 29                	push   $0x29
  800e5b:	68 81 17 80 00       	push   $0x801781
  800e60:	e8 06 03 00 00       	call   80116b <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e89:	8d 35 91 0e 80 00    	lea    0x800e91,%esi
  800e8f:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ebc:	8d 35 c4 0e 80 00    	lea    0x800ec4,%esi
  800ec2:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800eda:	b8 0b 00 00 00       	mov    $0xb,%eax
  ...
  800eed:	8d 35 f5 0e 80 00    	lea    0x800ef5,%esi
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f0b:	b8 05 00 00 00       	mov    $0x5,%eax
...
00800f29 <label_244>:
  ...
  800f33:	7e 17                	jle    800f4c <label_244+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800f35:	83 ec 0c             	sub    $0xc,%esp
  800f38:	50                   	push   %eax
  800f39:	6a 05                	push   $0x5
  800f3b:	68 64 17 80 00       	push   $0x801764
  800f40:	6a 29                	push   $0x29
  800f42:	68 81 17 80 00       	push   $0x801781
  800f47:	e8 1f 02 00 00       	call   80116b <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800f64:	89 45 e8             	mov    %eax,-0x18(%ebp)
  ...
  800f73:	8b 45 18             	mov    0x18(%ebp),%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800f79:	8d 55 e4             	lea    -0x1c(%ebp),%edx
  800f7c:	b9 00 00 00 00       	mov    $0x0,%ecx
  800f81:	b8 06 00 00 00       	mov    $0x6,%eax
  800f86:	89 cb                	mov    %ecx,%ebx
  800f88:	89 cf                	mov    %ecx,%edi
  800f8a:	51                   	push   %ecx
  800f8b:	52                   	push   %edx
  800f8c:	53                   	push   %ebx
  800f8d:	56                   	push   %esi
...
00800f9a <label_304>:
  ...
  800fa4:	7e 17                	jle    800fbd <label_304+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800fa6:	83 ec 0c             	sub    $0xc,%esp
  800fa9:	50                   	push   %eax
  800faa:	6a 06                	push   $0x6
  800fac:	68 64 17 80 00       	push   $0x801764
  800fb1:	6a 29                	push   $0x29
  800fb3:	68 81 17 80 00       	push   $0x801781
  800fb8:	e8 ae 01 00 00       	call   80116b <_panic>
	args[1] = (uint32_t) srcva;
	args[2] = (uint32_t) dstenv;
	args[3] = (uint32_t) dstva;
	args[4] = (uint32_t) perm;
...
00800feb <label_353>:
  ...
  800ff5:	7e 17                	jle    80100e <label_353+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  800ff7:	83 ec 0c             	sub    $0xc,%esp
  800ffa:	50                   	push   %eax
  800ffb:	6a 07                	push   $0x7
  800ffd:	68 64 17 80 00       	push   $0x801764
  801002:	6a 29                	push   $0x29
  801004:	68 81 17 80 00       	push   $0x801781
  801009:	e8 5d 01 00 00       	call   80116b <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80101f:	b8 09 00 00 00       	mov    $0x9,%eax
...
0080103c <label_402>:
  ...
  801046:	7e 17                	jle    80105f <label_402+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  801048:	83 ec 0c             	sub    $0xc,%esp
  80104b:	50                   	push   %eax
  80104c:	6a 09                	push   $0x9
  80104e:	68 64 17 80 00       	push   $0x801764
  801053:	6a 29                	push   $0x29
  801055:	68 81 17 80 00       	push   $0x801781
  80105a:	e8 0c 01 00 00       	call   80116b <_panic>
...
00801066 <sys_env_set_pgfault_upcall>:
...
0080108d <label_451>:
  ...
  801097:	7e 17                	jle    8010b0 <label_451+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  801099:	83 ec 0c             	sub    $0xc,%esp
  80109c:	50                   	push   %eax
  80109d:	6a 0a                	push   $0xa
  80109f:	68 64 17 80 00       	push   $0x801764
  8010a4:	6a 29                	push   $0x29
  8010a6:	68 81 17 80 00       	push   $0x801781
  8010ab:	e8 bb 00 00 00       	call   80116b <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010d5:	8d 35 dd 10 80 00    	lea    0x8010dd,%esi
  8010db:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010f3:	b8 0d 00 00 00       	mov    $0xd,%eax
  8010f8:	8b 55 08             	mov    0x8(%ebp),%edx
  8010fb:	89 d9                	mov    %ebx,%ecx
...
0080110f <label_537>:
  ...
  801119:	7e 17                	jle    801132 <label_537+0x23>
		panic("syscall %d returned %d (> 0)", num, ret);
  80111b:	83 ec 0c             	sub    $0xc,%esp
  80111e:	50                   	push   %eax
  80111f:	6a 0d                	push   $0xd
  801121:	68 64 17 80 00       	push   $0x801764
  801126:	6a 29                	push   $0x29
  801128:	68 81 17 80 00       	push   $0x801781
  80112d:	e8 39 00 00 00       	call   80116b <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80116f:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  801170:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	if (argv0)
  801173:	a1 10 20 80 00       	mov    0x802010,%eax
  801178:	85 c0                	test   %eax,%eax
  80117a:	74 11                	je     80118d <_panic+0x22>
		cprintf("%s: ", argv0);
  80117c:	83 ec 08             	sub    $0x8,%esp
  80117f:	50                   	push   %eax
  801180:	68 8f 17 80 00       	push   $0x80178f
  801185:	e8 1a f0 ff ff       	call   8001a4 <cprintf>
  80118a:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80118d:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801193:	e8 d4 fc ff ff       	call   800e6c <sys_getenvid>
  801198:	83 ec 0c             	sub    $0xc,%esp
  80119b:	ff 75 0c             	pushl  0xc(%ebp)
  80119e:	ff 75 08             	pushl  0x8(%ebp)
  8011a1:	56                   	push   %esi
  8011a2:	50                   	push   %eax
  8011a3:	68 94 17 80 00       	push   $0x801794
  8011a8:	e8 f7 ef ff ff       	call   8001a4 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8011ad:	83 c4 18             	add    $0x18,%esp
  8011b0:	53                   	push   %ebx
  8011b1:	ff 75 10             	pushl  0x10(%ebp)
  8011b4:	e8 9a ef ff ff       	call   800153 <vcprintf>
	cprintf("\n");
  8011b9:	c7 04 24 8d 14 80 00 	movl   $0x80148d,(%esp)
  8011c0:	e8 df ef ff ff       	call   8001a4 <cprintf>
  8011c5:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  8011c8:	cc                   	int3   
  8011c9:	eb fd                	jmp    8011c8 <_panic+0x5d>
