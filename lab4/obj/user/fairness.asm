...
umain(int argc, char **argv)
{
  ...
  800058:	56                   	push   %esi
  800059:	e8 d4 10 00 00       	call   801132 <ipc_recv>
			cprintf("%x recv from %x\n", id, who);
  80005e:	83 c4 0c             	add    $0xc,%esp
  800061:	ff 75 f4             	pushl  -0xc(%ebp)
  800064:	53                   	push   %ebx
  800065:	68 a0 14 80 00       	push   $0x8014a0
  ...
  80007c:	50                   	push   %eax
  80007d:	53                   	push   %ebx
  80007e:	68 b1 14 80 00       	push   $0x8014b1
  ...
  800096:	50                   	push   %eax
  800097:	e8 ad 10 00 00       	call   801149 <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800204:	e8 37 11 00 00       	call   801340 <__umoddi3>
  800209:	83 c4 14             	add    $0x14,%esp
  80020c:	0f be 80 d2 14 80 00 	movsbl 0x8014d2(%eax),%eax
  800213:	50                   	push   %eax
  ...
  8002e6:	e8 55 10 00 00       	call   801340 <__umoddi3>
  8002eb:	83 c4 14             	add    $0x14,%esp
  8002ee:	0f be 80 d2 14 80 00 	movsbl 0x8014d2(%eax),%eax
  8002f5:	50                   	push   %eax
  ...
  80031c:	e8 ef 0e 00 00       	call   801210 <__udivdi3>
  ...
  800342:	e8 f9 0f 00 00       	call   801340 <__umoddi3>
  800347:	83 c4 14             	add    $0x14,%esp
  80034a:	0f be 80 d2 14 80 00 	movsbl 0x8014d2(%eax),%eax
  800351:	50                   	push   %eax
  ...
  800378:	e8 93 0e 00 00       	call   801210 <__udivdi3>
  ...
  80039e:	e8 9d 0f 00 00       	call   801340 <__umoddi3>
  8003a3:	83 c4 14             	add    $0x14,%esp
  8003a6:	0f be 80 d2 14 80 00 	movsbl 0x8014d2(%eax),%eax
  8003ad:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004c1:	ff 24 85 20 16 80 00 	jmp    *0x801620(,%eax,4)
  ...
  8005a7:	8b 14 85 80 17 80 00 	mov    0x801780(,%eax,4),%edx
  8005ae:	85 d2                	test   %edx,%edx
  8005b0:	75 15                	jne    8005c7 <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  8005b2:	50                   	push   %eax
  8005b3:	68 ea 14 80 00       	push   $0x8014ea
  8005b8:	53                   	push   %ebx
  8005b9:	57                   	push   %edi
  ...
  8005c7:	52                   	push   %edx
  8005c8:	68 f3 14 80 00       	push   $0x8014f3
  8005cd:	53                   	push   %ebx
  8005ce:	57                   	push   %edi
  ...
  8005e9:	b9 e3 14 80 00       	mov    $0x8014e3,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  800865:	68 8c 15 80 00       	push   $0x80158c
  80086a:	68 f3 14 80 00       	push   $0x8014f3
  ...
  800886:	68 c4 15 80 00       	push   $0x8015c4
  80088b:	68 f3 14 80 00       	push   $0x8014f3
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800dc0:	8d 35 c8 0d 80 00    	lea    0x800dc8,%esi
  800dc6:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800df1:	8d 35 f9 0d 80 00    	lea    0x800df9,%esi
  800df7:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e23:	8d 35 2b 0e 80 00    	lea    0x800e2b,%esi
...
00800e2b <label_90>:
  ...
  800e34:	7e 17                	jle    800e4d <label_90+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800e36:	83 ec 0c             	sub    $0xc,%esp
  800e39:	50                   	push   %eax
  800e3a:	6a 03                	push   $0x3
  800e3c:	68 a4 17 80 00       	push   $0x8017a4
  800e41:	6a 2a                	push   $0x2a
  800e43:	68 c1 17 80 00       	push   $0x8017c1
  800e48:	e8 5e 03 00 00       	call   8011ab <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ea5:	8d 35 ad 0e 80 00    	lea    0x800ead,%esi
  800eab:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ed6:	8d 35 de 0e 80 00    	lea    0x800ede,%esi
  800edc:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f0a:	8d 35 12 0f 80 00    	lea    0x800f12,%esi
  800f10:	0f 34                	sysenter 
...
00800f12 <label_244>:
  ...
  800f1b:	7e 17                	jle    800f34 <label_244+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800f1d:	83 ec 0c             	sub    $0xc,%esp
  800f20:	50                   	push   %eax
  800f21:	6a 05                	push   $0x5
  800f23:	68 a4 17 80 00       	push   $0x8017a4
  800f28:	6a 2a                	push   $0x2a
  800f2a:	68 c1 17 80 00       	push   $0x8017c1
  800f2f:	e8 77 02 00 00       	call   8011ab <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f5a:	8d 35 62 0f 80 00    	lea    0x800f62,%esi
  800f60:	0f 34                	sysenter 
...
00800f62 <label_295>:
  ...
  800f6b:	7e 17                	jle    800f84 <label_295+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800f6d:	83 ec 0c             	sub    $0xc,%esp
  800f70:	50                   	push   %eax
  800f71:	6a 06                	push   $0x6
  800f73:	68 a4 17 80 00       	push   $0x8017a4
  800f78:	6a 2a                	push   $0x2a
  800f7a:	68 c1 17 80 00       	push   $0x8017c1
  800f7f:	e8 27 02 00 00       	call   8011ab <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800fab:	8d 35 b3 0f 80 00    	lea    0x800fb3,%esi
  800fb1:	0f 34                	sysenter 
...
00800fb3 <label_344>:
  ...
  800fbc:	7e 17                	jle    800fd5 <label_344+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800fbe:	83 ec 0c             	sub    $0xc,%esp
  800fc1:	50                   	push   %eax
  800fc2:	6a 07                	push   $0x7
  800fc4:	68 a4 17 80 00       	push   $0x8017a4
  800fc9:	6a 2a                	push   $0x2a
  800fcb:	68 c1 17 80 00       	push   $0x8017c1
  800fd0:	e8 d6 01 00 00       	call   8011ab <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ffc:	8d 35 04 10 80 00    	lea    0x801004,%esi
  801002:	0f 34                	sysenter 
...
00801004 <label_393>:
  ...
  80100d:	7e 17                	jle    801026 <label_393+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  80100f:	83 ec 0c             	sub    $0xc,%esp
  801012:	50                   	push   %eax
  801013:	6a 09                	push   $0x9
  801015:	68 a4 17 80 00       	push   $0x8017a4
  80101a:	6a 2a                	push   $0x2a
  80101c:	68 c1 17 80 00       	push   $0x8017c1
  801021:	e8 85 01 00 00       	call   8011ab <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80104d:	8d 35 55 10 80 00    	lea    0x801055,%esi
...
00801055 <label_442>:
  ...
  80105e:	7e 17                	jle    801077 <label_442+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  801060:	83 ec 0c             	sub    $0xc,%esp
  801063:	50                   	push   %eax
  801064:	6a 0a                	push   $0xa
  801066:	68 a4 17 80 00       	push   $0x8017a4
  80106b:	6a 2a                	push   $0x2a
  80106d:	68 c1 17 80 00       	push   $0x8017c1
  801072:	e8 34 01 00 00       	call   8011ab <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80109d:	8d 35 a5 10 80 00    	lea    0x8010a5,%esi
  8010a3:	0f 34                	sysenter 
...
008010d7 <label_528>:
  ...
  8010e0:	7e 17                	jle    8010f9 <label_528+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  8010e2:	83 ec 0c             	sub    $0xc,%esp
  8010e5:	50                   	push   %eax
  8010e6:	6a 0d                	push   $0xd
  8010e8:	68 a4 17 80 00       	push   $0x8017a4
  8010ed:	6a 2a                	push   $0x2a
  8010ef:	68 c1 17 80 00       	push   $0x8017c1
  8010f4:	e8 b2 00 00 00       	call   8011ab <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80111f:	8d 35 27 11 80 00    	lea    0x801127,%esi
  801125:	0f 34                	sysenter 
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801138:	68 cf 17 80 00       	push   $0x8017cf
  80113d:	6a 1a                	push   $0x1a
  80113f:	68 e8 17 80 00       	push   $0x8017e8
  801144:	e8 62 00 00 00       	call   8011ab <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80114f:	68 f2 17 80 00       	push   $0x8017f2
  801154:	6a 2a                	push   $0x2a
  801156:	68 e8 17 80 00       	push   $0x8017e8
  80115b:	e8 4b 00 00 00       	call   8011ab <_panic>
...
ipc_find_env(enum EnvType type)
{
  ...
  801166:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  80116b:	39 c1                	cmp    %eax,%ecx
  80116d:	74 19                	je     801188 <ipc_find_env+0x28>
  80116f:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  801184:	75 14                	jne    80119a <ipc_find_env+0x3a>
  801186:	eb 05                	jmp    80118d <ipc_find_env+0x2d>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
...
ipc_find_env(enum EnvType type)
{
  ...
  8011a2:	75 d0                	jne    801174 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011b0:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  8011b3:	a1 10 20 80 00       	mov    0x802010,%eax
  8011b8:	85 c0                	test   %eax,%eax
  8011ba:	74 11                	je     8011cd <_panic+0x22>
		cprintf("%s: ", argv0);
  8011bc:	83 ec 08             	sub    $0x8,%esp
  8011bf:	50                   	push   %eax
  8011c0:	68 0b 18 80 00       	push   $0x80180b
  8011c5:	e8 c2 ef ff ff       	call   80018c <cprintf>
  8011ca:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8011cd:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8011d3:	e8 7c fc ff ff       	call   800e54 <sys_getenvid>
  8011d8:	83 ec 0c             	sub    $0xc,%esp
  8011db:	ff 75 0c             	pushl  0xc(%ebp)
  8011de:	ff 75 08             	pushl  0x8(%ebp)
  8011e1:	56                   	push   %esi
  8011e2:	50                   	push   %eax
  8011e3:	68 10 18 80 00       	push   $0x801810
  8011e8:	e8 9f ef ff ff       	call   80018c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8011ed:	83 c4 18             	add    $0x18,%esp
  8011f0:	53                   	push   %ebx
  8011f1:	ff 75 10             	pushl  0x10(%ebp)
  8011f4:	e8 42 ef ff ff       	call   80013b <vcprintf>
	cprintf("\n");
  8011f9:	c7 04 24 af 14 80 00 	movl   $0x8014af,(%esp)
  801200:	e8 87 ef ff ff       	call   80018c <cprintf>
  801205:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  801208:	cc                   	int3   
  801209:	eb fd                	jmp    801208 <_panic+0x5d>
