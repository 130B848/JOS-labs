...
sgdt(struct Pseudodesc* gdtd)
{
  ...
  8000c5:	68 e0 14 80 00       	push   $0x8014e0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002aa:	e8 c1 10 00 00       	call   801370 <__umoddi3>
  8002af:	83 c4 14             	add    $0x14,%esp
  8002b2:	0f be 80 06 15 80 00 	movsbl 0x801506(%eax),%eax
  8002b9:	50                   	push   %eax
  ...
  80038c:	e8 df 0f 00 00       	call   801370 <__umoddi3>
  800391:	83 c4 14             	add    $0x14,%esp
  800394:	0f be 80 06 15 80 00 	movsbl 0x801506(%eax),%eax
  80039b:	50                   	push   %eax
  ...
  8003c2:	e8 79 0e 00 00       	call   801240 <__udivdi3>
  ...
  8003e8:	e8 83 0f 00 00       	call   801370 <__umoddi3>
  8003ed:	83 c4 14             	add    $0x14,%esp
  8003f0:	0f be 80 06 15 80 00 	movsbl 0x801506(%eax),%eax
  8003f7:	50                   	push   %eax
  ...
  80041e:	e8 1d 0e 00 00       	call   801240 <__udivdi3>
  ...
  800444:	e8 27 0f 00 00       	call   801370 <__umoddi3>
  800449:	83 c4 14             	add    $0x14,%esp
  80044c:	0f be 80 06 15 80 00 	movsbl 0x801506(%eax),%eax
  800453:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800567:	ff 24 85 40 16 80 00 	jmp    *0x801640(,%eax,4)
  ...
  80064d:	8b 14 85 a0 17 80 00 	mov    0x8017a0(,%eax,4),%edx
  800654:	85 d2                	test   %edx,%edx
  800656:	75 15                	jne    80066d <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  800658:	50                   	push   %eax
  800659:	68 1e 15 80 00       	push   $0x80151e
  80065e:	53                   	push   %ebx
  80065f:	57                   	push   %edi
  ...
  80066d:	52                   	push   %edx
  80066e:	68 27 15 80 00       	push   $0x801527
  800673:	53                   	push   %ebx
  800674:	57                   	push   %edi
  ...
  80068f:	b9 17 15 80 00       	mov    $0x801517,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  80090b:	68 c0 15 80 00       	push   $0x8015c0
  800910:	68 27 15 80 00       	push   $0x801527
  ...
  80092c:	68 f8 15 80 00       	push   $0x8015f8
  800931:	68 27 15 80 00       	push   $0x801527
...
00800ed1 <label_90>:
  ...
  800ee2:	68 c4 17 80 00       	push   $0x8017c4
  800ee7:	6a 2a                	push   $0x2a
  800ee9:	68 e1 17 80 00       	push   $0x8017e1
  800eee:	e8 e5 02 00 00       	call   8011d8 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f7c:	8d 35 84 0f 80 00    	lea    0x800f84,%esi
  800f82:	0f 34                	sysenter 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800fb0:	8d 35 b8 0f 80 00    	lea    0x800fb8,%esi
  800fb6:	0f 34                	sysenter 
...
00800fb8 <label_244>:
  ...
  800fc1:	7e 17                	jle    800fda <label_244+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  800fc3:	83 ec 0c             	sub    $0xc,%esp
  800fc6:	50                   	push   %eax
  800fc7:	6a 05                	push   $0x5
  800fc9:	68 c4 17 80 00       	push   $0x8017c4
  800fce:	6a 2a                	push   $0x2a
  800fd0:	68 e1 17 80 00       	push   $0x8017e1
  800fd5:	e8 fe 01 00 00       	call   8011d8 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801000:	8d 35 08 10 80 00    	lea    0x801008,%esi
  801006:	0f 34                	sysenter 
...
00801008 <label_295>:
  ...
  801011:	7e 17                	jle    80102a <label_295+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  801013:	83 ec 0c             	sub    $0xc,%esp
  801016:	50                   	push   %eax
  801017:	6a 06                	push   $0x6
  801019:	68 c4 17 80 00       	push   $0x8017c4
  80101e:	6a 2a                	push   $0x2a
  801020:	68 e1 17 80 00       	push   $0x8017e1
  801025:	e8 ae 01 00 00       	call   8011d8 <_panic>
...
00801059 <label_344>:
  ...
  801062:	7e 17                	jle    80107b <label_344+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  801064:	83 ec 0c             	sub    $0xc,%esp
  801067:	50                   	push   %eax
  801068:	6a 07                	push   $0x7
  80106a:	68 c4 17 80 00       	push   $0x8017c4
  80106f:	6a 2a                	push   $0x2a
  801071:	68 e1 17 80 00       	push   $0x8017e1
  801076:	e8 5d 01 00 00       	call   8011d8 <_panic>
...
008010aa <label_393>:
  ...
  8010b3:	7e 17                	jle    8010cc <label_393+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  8010b5:	83 ec 0c             	sub    $0xc,%esp
  8010b8:	50                   	push   %eax
  8010b9:	6a 09                	push   $0x9
  8010bb:	68 c4 17 80 00       	push   $0x8017c4
  8010c0:	6a 2a                	push   $0x2a
  8010c2:	68 e1 17 80 00       	push   $0x8017e1
  8010c7:	e8 0c 01 00 00       	call   8011d8 <_panic>
...
008010d3 <sys_env_set_pgfault_upcall>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010dd:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  8010f3:	8d 35 fb 10 80 00    	lea    0x8010fb,%esi
  8010f9:	0f 34                	sysenter 
...
008010fb <label_442>:
  ...
  801104:	7e 17                	jle    80111d <label_442+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  801106:	83 ec 0c             	sub    $0xc,%esp
  801109:	50                   	push   %eax
  80110a:	6a 0a                	push   $0xa
  80110c:	68 c4 17 80 00       	push   $0x8017c4
  801111:	6a 2a                	push   $0x2a
  801113:	68 e1 17 80 00       	push   $0x8017e1
  801118:	e8 bb 00 00 00       	call   8011d8 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801137:	8b 7d 14             	mov    0x14(%ebp),%edi
  80113a:	51                   	push   %ecx
  80113b:	52                   	push   %edx
  80113c:	53                   	push   %ebx
  80113d:	54                   	push   %esp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801160:	b8 0d 00 00 00       	mov    $0xd,%eax
  801165:	8b 55 08             	mov    0x8(%ebp),%edx
  801168:	89 d9                	mov    %ebx,%ecx
...
0080117d <label_528>:
  ...
  801186:	7e 17                	jle    80119f <label_528+0x22>
	panic("syscall %d returned %d (> 0)", num, ret);
  801188:	83 ec 0c             	sub    $0xc,%esp
  80118b:	50                   	push   %eax
  80118c:	6a 0d                	push   $0xd
  80118e:	68 c4 17 80 00       	push   $0x8017c4
  801193:	6a 2a                	push   $0x2a
  801195:	68 e1 17 80 00       	push   $0x8017e1
  80119a:	e8 39 00 00 00       	call   8011d8 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8011c5:	8d 35 cd 11 80 00    	lea    0x8011cd,%esi
  8011cb:	0f 34                	sysenter 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011dc:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  8011dd:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	if (argv0)
  8011e0:	a1 70 30 80 00       	mov    0x803070,%eax
  8011e5:	85 c0                	test   %eax,%eax
  8011e7:	74 11                	je     8011fa <_panic+0x22>
		cprintf("%s: ", argv0);
  8011e9:	83 ec 08             	sub    $0x8,%esp
  8011ec:	50                   	push   %eax
  8011ed:	68 ef 17 80 00       	push   $0x8017ef
  8011f2:	e8 3b f0 ff ff       	call   800232 <cprintf>
  8011f7:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8011fa:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801200:	e8 f5 fc ff ff       	call   800efa <sys_getenvid>
  801205:	83 ec 0c             	sub    $0xc,%esp
  801208:	ff 75 0c             	pushl  0xc(%ebp)
  80120b:	ff 75 08             	pushl  0x8(%ebp)
  80120e:	56                   	push   %esi
  80120f:	50                   	push   %eax
  801210:	68 f4 17 80 00       	push   $0x8017f4
  801215:	e8 18 f0 ff ff       	call   800232 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80121a:	83 c4 18             	add    $0x18,%esp
  80121d:	53                   	push   %ebx
  80121e:	ff 75 10             	pushl  0x10(%ebp)
  801221:	e8 bb ef ff ff       	call   8001e1 <vcprintf>
	cprintf("\n");
  801226:	c7 04 24 fa 14 80 00 	movl   $0x8014fa,(%esp)
  80122d:	e8 00 f0 ff ff       	call   800232 <cprintf>
  801232:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  801235:	cc                   	int3   
  801236:	eb fd                	jmp    801235 <_panic+0x5d>
