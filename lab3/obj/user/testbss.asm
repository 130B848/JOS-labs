...
umain(int argc, char **argv)
{
  ...
  800039:	68 34 12 80 00       	push   $0x801234
...
umain(int argc, char **argv)
{
  ...
  800065:	50                   	push   %eax
  800066:	68 af 12 80 00       	push   $0x8012af
  80006b:	6a 11                	push   $0x11
  80006d:	68 cc 12 80 00       	push   $0x8012cc
...
umain(int argc, char **argv)
{
  ...
  8000b5:	50                   	push   %eax
  8000b6:	68 54 12 80 00       	push   $0x801254
  8000bb:	6a 16                	push   $0x16
  8000bd:	68 cc 12 80 00       	push   $0x8012cc
  ...
  8000d4:	68 7c 12 80 00       	push   $0x80127c
  ...
  8000eb:	68 db 12 80 00       	push   $0x8012db
  8000f0:	6a 1a                	push   $0x1a
  8000f2:	68 cc 12 80 00       	push   $0x8012cc
...
libmain(int argc, char **argv)
{
  ...
  800111:	6b c0 64             	imul   $0x64,%eax,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800168:	50                   	push   %eax
  800169:	68 fc 12 80 00       	push   $0x8012fc
  ...
  80018a:	56                   	push   %esi
  80018b:	50                   	push   %eax
  80018c:	68 04 13 80 00       	push   $0x801304
  ...
  80019d:	e8 54 00 00 00       	call   8001f6 <vcprintf>
	cprintf("\n");
  8001a2:	c7 04 24 ca 12 80 00 	movl   $0x8012ca,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bf:	e8 1c 0e 00 00       	call   8010e0 <__umoddi3>
  8002c4:	83 c4 14             	add    $0x14,%esp
  8002c7:	0f be 80 27 13 80 00 	movsbl 0x801327(%eax),%eax
  8002ce:	50                   	push   %eax
  ...
  8003a1:	e8 3a 0d 00 00       	call   8010e0 <__umoddi3>
  8003a6:	83 c4 14             	add    $0x14,%esp
  8003a9:	0f be 80 27 13 80 00 	movsbl 0x801327(%eax),%eax
  8003b0:	50                   	push   %eax
  ...
  8003d7:	e8 d4 0b 00 00       	call   800fb0 <__udivdi3>
  ...
  8003fd:	e8 de 0c 00 00       	call   8010e0 <__umoddi3>
  800402:	83 c4 14             	add    $0x14,%esp
  800405:	0f be 80 27 13 80 00 	movsbl 0x801327(%eax),%eax
  80040c:	50                   	push   %eax
  ...
  800433:	e8 78 0b 00 00       	call   800fb0 <__udivdi3>
  ...
  800459:	e8 82 0c 00 00       	call   8010e0 <__umoddi3>
  80045e:	83 c4 14             	add    $0x14,%esp
  800461:	0f be 80 27 13 80 00 	movsbl 0x801327(%eax),%eax
  800468:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80057c:	ff 24 85 30 14 80 00 	jmp    *0x801430(,%eax,4)
  ...
  80065d:	83 f8 06             	cmp    $0x6,%eax
  800660:	7f 0b                	jg     80066d <vprintfmt+0x183>
  800662:	8b 14 85 88 15 80 00 	mov    0x801588(,%eax,4),%edx
  800669:	85 d2                	test   %edx,%edx
  80066b:	75 15                	jne    800682 <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  80066d:	50                   	push   %eax
  80066e:	68 3f 13 80 00       	push   $0x80133f
  800673:	53                   	push   %ebx
  800674:	57                   	push   %edi
  ...
  800682:	52                   	push   %edx
  800683:	68 48 13 80 00       	push   $0x801348
  800688:	53                   	push   %ebx
  800689:	57                   	push   %edi
  ...
  8006a4:	b9 38 13 80 00       	mov    $0x801338,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  800920:	68 b4 13 80 00       	push   $0x8013b4
  800925:	68 48 13 80 00       	push   $0x801348
  ...
  800941:	68 ec 13 80 00       	push   $0x8013ec
  800946:	68 48 13 80 00       	push   $0x801348
...
00800ee6 <label_90>:
  ...
  800ef7:	68 a4 15 80 00       	push   $0x8015a4
  800efc:	6a 2a                	push   $0x2a
  800efe:	68 c1 15 80 00       	push   $0x8015c1
...
00800fb0 <__udivdi3>:
  ...
  800fb7:	8b 74 24 3c          	mov    0x3c(%esp),%esi
  800fbb:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  800fbf:	8b 4c 24 34          	mov    0x34(%esp),%ecx
  800fc3:	8b 7c 24 38          	mov    0x38(%esp),%edi
  800fc7:	85 f6                	test   %esi,%esi
  800fc9:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800fcd:	89 ca                	mov    %ecx,%edx
  800fcf:	89 f8                	mov    %edi,%eax
  800fd1:	75 3d                	jne    801010 <__udivdi3+0x60>
  800fd3:	39 cf                	cmp    %ecx,%edi
  800fd5:	0f 87 c5 00 00 00    	ja     8010a0 <__udivdi3+0xf0>
  800fdb:	85 ff                	test   %edi,%edi
  800fdd:	89 fd                	mov    %edi,%ebp
  800fdf:	75 0b                	jne    800fec <__udivdi3+0x3c>
  800fe1:	b8 01 00 00 00       	mov    $0x1,%eax
  800fe6:	31 d2                	xor    %edx,%edx
  800fe8:	f7 f7                	div    %edi
  800fea:	89 c5                	mov    %eax,%ebp
  800fec:	89 c8                	mov    %ecx,%eax
  800fee:	31 d2                	xor    %edx,%edx
  800ff0:	f7 f5                	div    %ebp
  800ff2:	89 c1                	mov    %eax,%ecx
  800ff4:	89 d8                	mov    %ebx,%eax
  800ff6:	89 cf                	mov    %ecx,%edi
  800ff8:	f7 f5                	div    %ebp
  ...
  801010:	39 ce                	cmp    %ecx,%esi
  801012:	77 74                	ja     801088 <__udivdi3+0xd8>
  801014:	0f bd fe             	bsr    %esi,%edi
  801017:	83 f7 1f             	xor    $0x1f,%edi
  80101a:	0f 84 98 00 00 00    	je     8010b8 <__udivdi3+0x108>
  801020:	bb 20 00 00 00       	mov    $0x20,%ebx
  801025:	89 f9                	mov    %edi,%ecx
  801027:	89 c5                	mov    %eax,%ebp
  801029:	29 fb                	sub    %edi,%ebx
  80102b:	d3 e6                	shl    %cl,%esi
  80102d:	89 d9                	mov    %ebx,%ecx
  80102f:	d3 ed                	shr    %cl,%ebp
  801031:	89 f9                	mov    %edi,%ecx
  801033:	d3 e0                	shl    %cl,%eax
  801035:	09 ee                	or     %ebp,%esi
  801037:	89 d9                	mov    %ebx,%ecx
  801039:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80103d:	89 d5                	mov    %edx,%ebp
  80103f:	8b 44 24 08          	mov    0x8(%esp),%eax
  801043:	d3 ed                	shr    %cl,%ebp
  801045:	89 f9                	mov    %edi,%ecx
  801047:	d3 e2                	shl    %cl,%edx
  801049:	89 d9                	mov    %ebx,%ecx
  80104b:	d3 e8                	shr    %cl,%eax
  80104d:	09 c2                	or     %eax,%edx
  80104f:	89 d0                	mov    %edx,%eax
  801051:	89 ea                	mov    %ebp,%edx
  801053:	f7 f6                	div    %esi
  801055:	89 d5                	mov    %edx,%ebp
  801057:	89 c3                	mov    %eax,%ebx
  801059:	f7 64 24 0c          	mull   0xc(%esp)
  80105d:	39 d5                	cmp    %edx,%ebp
  80105f:	72 10                	jb     801071 <__udivdi3+0xc1>
  801061:	8b 74 24 08          	mov    0x8(%esp),%esi
  801065:	89 f9                	mov    %edi,%ecx
  801067:	d3 e6                	shl    %cl,%esi
  801069:	39 c6                	cmp    %eax,%esi
  80106b:	73 07                	jae    801074 <__udivdi3+0xc4>
  80106d:	39 d5                	cmp    %edx,%ebp
  80106f:	75 03                	jne    801074 <__udivdi3+0xc4>
  801071:	83 eb 01             	sub    $0x1,%ebx
  ...
  80108a:	31 db                	xor    %ebx,%ebx
  80108c:	89 d8                	mov    %ebx,%eax
  80108e:	89 fa                	mov    %edi,%edx
  801090:	83 c4 1c             	add    $0x1c,%esp
  801093:	5b                   	pop    %ebx
  801094:	5e                   	pop    %esi
  801095:	5f                   	pop    %edi
  801096:	5d                   	pop    %ebp
  ...
  8010a2:	f7 f7                	div    %edi
  8010a4:	31 ff                	xor    %edi,%edi
  8010a6:	89 c3                	mov    %eax,%ebx
  8010a8:	89 d8                	mov    %ebx,%eax
  8010aa:	89 fa                	mov    %edi,%edx
  ...
  8010b8:	39 ce                	cmp    %ecx,%esi
  8010ba:	72 0c                	jb     8010c8 <__udivdi3+0x118>
  8010bc:	31 db                	xor    %ebx,%ebx
  8010be:	3b 44 24 08          	cmp    0x8(%esp),%eax
  8010c2:	0f 87 34 ff ff ff    	ja     800ffc <__udivdi3+0x4c>
  8010c8:	bb 01 00 00 00       	mov    $0x1,%ebx
  8010cd:	e9 2a ff ff ff       	jmp    800ffc <__udivdi3+0x4c>
...
008010e0 <__umoddi3>:
  ...
  8010e7:	8b 54 24 3c          	mov    0x3c(%esp),%edx
  8010eb:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  8010ef:	8b 74 24 34          	mov    0x34(%esp),%esi
  8010f3:	8b 7c 24 38          	mov    0x38(%esp),%edi
  8010f7:	85 d2                	test   %edx,%edx
  8010f9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  8010fd:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801101:	89 f3                	mov    %esi,%ebx
  801103:	89 3c 24             	mov    %edi,(%esp)
  801106:	89 74 24 04          	mov    %esi,0x4(%esp)
  80110a:	75 1c                	jne    801128 <__umoddi3+0x48>
  80110c:	39 f7                	cmp    %esi,%edi
  80110e:	76 50                	jbe    801160 <__umoddi3+0x80>
  801110:	89 c8                	mov    %ecx,%eax
  801112:	89 f2                	mov    %esi,%edx
  801114:	f7 f7                	div    %edi
  ...
  80112c:	77 52                	ja     801180 <__umoddi3+0xa0>
  80112e:	0f bd ea             	bsr    %edx,%ebp
  801131:	83 f5 1f             	xor    $0x1f,%ebp
  801134:	75 5a                	jne    801190 <__umoddi3+0xb0>
  801136:	3b 54 24 04          	cmp    0x4(%esp),%edx
  80113a:	0f 82 e0 00 00 00    	jb     801220 <__umoddi3+0x140>
  801140:	39 0c 24             	cmp    %ecx,(%esp)
  801143:	0f 86 d7 00 00 00    	jbe    801220 <__umoddi3+0x140>
  801149:	8b 44 24 08          	mov    0x8(%esp),%eax
  80114d:	8b 54 24 04          	mov    0x4(%esp),%edx
  ...
  801190:	8b 34 24             	mov    (%esp),%esi
  801193:	bf 20 00 00 00       	mov    $0x20,%edi
  801198:	89 e9                	mov    %ebp,%ecx
  80119a:	29 ef                	sub    %ebp,%edi
  80119c:	d3 e0                	shl    %cl,%eax
  80119e:	89 f9                	mov    %edi,%ecx
  8011a0:	89 f2                	mov    %esi,%edx
  8011a2:	d3 ea                	shr    %cl,%edx
  8011a4:	89 e9                	mov    %ebp,%ecx
  8011a6:	09 c2                	or     %eax,%edx
  8011a8:	89 d8                	mov    %ebx,%eax
  8011aa:	89 14 24             	mov    %edx,(%esp)
  8011ad:	89 f2                	mov    %esi,%edx
  8011af:	d3 e2                	shl    %cl,%edx
  8011b1:	89 f9                	mov    %edi,%ecx
  8011b3:	89 54 24 04          	mov    %edx,0x4(%esp)
  8011b7:	8b 54 24 0c          	mov    0xc(%esp),%edx
  8011bb:	d3 e8                	shr    %cl,%eax
  8011bd:	89 e9                	mov    %ebp,%ecx
  8011bf:	89 c6                	mov    %eax,%esi
  8011c1:	d3 e3                	shl    %cl,%ebx
  8011c3:	89 f9                	mov    %edi,%ecx
  8011c5:	89 d0                	mov    %edx,%eax
  8011c7:	d3 e8                	shr    %cl,%eax
  8011c9:	89 e9                	mov    %ebp,%ecx
  8011cb:	09 d8                	or     %ebx,%eax
  8011cd:	89 d3                	mov    %edx,%ebx
  8011cf:	89 f2                	mov    %esi,%edx
  8011d1:	f7 34 24             	divl   (%esp)
  8011d4:	89 d6                	mov    %edx,%esi
  8011d6:	d3 e3                	shl    %cl,%ebx
  8011d8:	f7 64 24 04          	mull   0x4(%esp)
  8011dc:	39 d6                	cmp    %edx,%esi
  8011de:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8011e2:	89 d1                	mov    %edx,%ecx
  8011e4:	89 c3                	mov    %eax,%ebx
  8011e6:	72 08                	jb     8011f0 <__umoddi3+0x110>
  8011e8:	75 11                	jne    8011fb <__umoddi3+0x11b>
  8011ea:	39 44 24 08          	cmp    %eax,0x8(%esp)
  8011ee:	73 0b                	jae    8011fb <__umoddi3+0x11b>
  8011f0:	2b 44 24 04          	sub    0x4(%esp),%eax
  8011f4:	1b 14 24             	sbb    (%esp),%edx
  8011f7:	89 d1                	mov    %edx,%ecx
  8011f9:	89 c3                	mov    %eax,%ebx
  8011fb:	8b 54 24 08          	mov    0x8(%esp),%edx
  8011ff:	29 da                	sub    %ebx,%edx
  801201:	19 ce                	sbb    %ecx,%esi
  801203:	89 f9                	mov    %edi,%ecx
  801205:	89 f0                	mov    %esi,%eax
  801207:	d3 e0                	shl    %cl,%eax
  801209:	89 e9                	mov    %ebp,%ecx
  80120b:	d3 ea                	shr    %cl,%edx
  80120d:	89 e9                	mov    %ebp,%ecx
  80120f:	d3 ee                	shr    %cl,%esi
  801211:	09 d0                	or     %edx,%eax
  801213:	89 f2                	mov    %esi,%edx
  801215:	83 c4 1c             	add    $0x1c,%esp
  801218:	5b                   	pop    %ebx
  801219:	5e                   	pop    %esi
  80121a:	5f                   	pop    %edi
  80121b:	5d                   	pop    %ebp
  ...
  801220:	29 f9                	sub    %edi,%ecx
  801222:	19 d6                	sbb    %edx,%esi
  801224:	89 74 24 04          	mov    %esi,0x4(%esp)
  801228:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  80122c:	e9 18 ff ff ff       	jmp    801149 <__umoddi3+0x69>
