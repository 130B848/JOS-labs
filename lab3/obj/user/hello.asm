...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 14             	sub    $0x14,%esp
	cprintf("hello, world\n");
  800039:	68 94 11 80 00       	push   $0x801194
  ...
  80004e:	50                   	push   %eax
  80004f:	68 a2 11 80 00       	push   $0x8011a2
...
libmain(int argc, char **argv)
{
  ...
  800073:	6b c0 64             	imul   $0x64,%eax,%eax
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001c1:	e8 7a 0e 00 00       	call   801040 <__umoddi3>
  8001c6:	83 c4 14             	add    $0x14,%esp
  8001c9:	0f be 80 c3 11 80 00 	movsbl 0x8011c3(%eax),%eax
  8001d0:	50                   	push   %eax
  ...
  8002a3:	e8 98 0d 00 00       	call   801040 <__umoddi3>
  8002a8:	83 c4 14             	add    $0x14,%esp
  8002ab:	0f be 80 c3 11 80 00 	movsbl 0x8011c3(%eax),%eax
  8002b2:	50                   	push   %eax
  ...
  8002d9:	e8 32 0c 00 00       	call   800f10 <__udivdi3>
  ...
  8002ff:	e8 3c 0d 00 00       	call   801040 <__umoddi3>
  800304:	83 c4 14             	add    $0x14,%esp
  800307:	0f be 80 c3 11 80 00 	movsbl 0x8011c3(%eax),%eax
  80030e:	50                   	push   %eax
  ...
  800335:	e8 d6 0b 00 00       	call   800f10 <__udivdi3>
  ...
  80035b:	e8 e0 0c 00 00       	call   801040 <__umoddi3>
  800360:	83 c4 14             	add    $0x14,%esp
  800363:	0f be 80 c3 11 80 00 	movsbl 0x8011c3(%eax),%eax
  80036a:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80047e:	ff 24 85 cc 12 80 00 	jmp    *0x8012cc(,%eax,4)
  ...
  80055f:	83 f8 06             	cmp    $0x6,%eax
  800562:	7f 0b                	jg     80056f <vprintfmt+0x183>
  800564:	8b 14 85 24 14 80 00 	mov    0x801424(,%eax,4),%edx
  80056b:	85 d2                	test   %edx,%edx
  80056d:	75 15                	jne    800584 <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  80056f:	50                   	push   %eax
  800570:	68 db 11 80 00       	push   $0x8011db
  800575:	53                   	push   %ebx
  800576:	57                   	push   %edi
  ...
  800584:	52                   	push   %edx
  800585:	68 e4 11 80 00       	push   $0x8011e4
  80058a:	53                   	push   %ebx
  80058b:	57                   	push   %edi
  ...
  8005a6:	b9 d4 11 80 00       	mov    $0x8011d4,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  800822:	68 50 12 80 00       	push   $0x801250
  800827:	68 e4 11 80 00       	push   $0x8011e4
  ...
  800843:	68 88 12 80 00       	push   $0x801288
  800848:	68 e4 11 80 00       	push   $0x8011e4
...
00800de8 <label_90>:
  ...
  800df9:	68 40 14 80 00       	push   $0x801440
  800dfe:	6a 2a                	push   $0x2a
  800e00:	68 5d 14 80 00       	push   $0x80145d
  800e05:	e8 9d 00 00 00       	call   800ea7 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800eac:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  800eaf:	a1 10 20 80 00       	mov    0x802010,%eax
  800eb4:	85 c0                	test   %eax,%eax
  800eb6:	74 11                	je     800ec9 <_panic+0x22>
		cprintf("%s: ", argv0);
  800eb8:	83 ec 08             	sub    $0x8,%esp
  800ebb:	50                   	push   %eax
  800ebc:	68 6b 14 80 00       	push   $0x80146b
  800ec1:	e8 83 f2 ff ff       	call   800149 <cprintf>
  800ec6:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800ec9:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800ecf:	e8 3d ff ff ff       	call   800e11 <sys_getenvid>
  800ed4:	83 ec 0c             	sub    $0xc,%esp
  800ed7:	ff 75 0c             	pushl  0xc(%ebp)
  800eda:	ff 75 08             	pushl  0x8(%ebp)
  800edd:	56                   	push   %esi
  800ede:	50                   	push   %eax
  800edf:	68 70 14 80 00       	push   $0x801470
  800ee4:	e8 60 f2 ff ff       	call   800149 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ee9:	83 c4 18             	add    $0x18,%esp
  800eec:	53                   	push   %ebx
  800eed:	ff 75 10             	pushl  0x10(%ebp)
  800ef0:	e8 03 f2 ff ff       	call   8000f8 <vcprintf>
	cprintf("\n");
  800ef5:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  800efc:	e8 48 f2 ff ff       	call   800149 <cprintf>
  800f01:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800f04:	cc                   	int3   
  800f05:	eb fd                	jmp    800f04 <_panic+0x5d>
