	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001b9:	0f be 80 b5 11 80 00 	movsbl 0x8011b5(%eax),%eax
  8001c0:	50                   	push   %eax
  ...
  80029b:	0f be 80 b5 11 80 00 	movsbl 0x8011b5(%eax),%eax
  8002a2:	50                   	push   %eax
  ...
  8002f7:	0f be 80 b5 11 80 00 	movsbl 0x8011b5(%eax),%eax
  8002fe:	50                   	push   %eax
  ...
  800353:	0f be 80 b5 11 80 00 	movsbl 0x8011b5(%eax),%eax
  80035a:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80046e:	ff 24 85 c0 12 80 00 	jmp    *0x8012c0(,%eax,4)
  ...
  800554:	8b 14 85 18 14 80 00 	mov    0x801418(,%eax,4),%edx
  80055b:	85 d2                	test   %edx,%edx
  80055d:	75 15                	jne    800574 <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  80055f:	50                   	push   %eax
  800560:	68 cd 11 80 00       	push   $0x8011cd
  800565:	53                   	push   %ebx
  800566:	57                   	push   %edi
  ...
  800574:	52                   	push   %edx
  800575:	68 d6 11 80 00       	push   $0x8011d6
  80057a:	53                   	push   %ebx
  80057b:	57                   	push   %edi
  ...
  800596:	b9 c6 11 80 00       	mov    $0x8011c6,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  800812:	68 44 12 80 00       	push   $0x801244
  800817:	68 d6 11 80 00       	push   $0x8011d6
  ...
  800833:	68 7c 12 80 00       	push   $0x80127c
  800838:	68 d6 11 80 00       	push   $0x8011d6
...
00800dd8 <label_90>:
  ...
  800de9:	68 34 14 80 00       	push   $0x801434
  800dee:	6a 2a                	push   $0x2a
  800df0:	68 51 14 80 00       	push   $0x801451
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800eab:	50                   	push   %eax
  800eac:	68 5f 14 80 00       	push   $0x80145f
  ...
  800ecd:	56                   	push   %esi
  800ece:	50                   	push   %eax
  800ecf:	68 68 14 80 00       	push   $0x801468
  ...
  800ee0:	e8 03 f2 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800ee5:	c7 04 24 64 14 80 00 	movl   $0x801464,(%esp)
