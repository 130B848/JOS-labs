...
umain(int argc, char **argv)
{
  ...
  80003f:	68 84 11 80 00       	push   $0x801184
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001b1:	e8 7a 0e 00 00       	call   801030 <__umoddi3>
  8001b6:	83 c4 14             	add    $0x14,%esp
  8001b9:	0f be 80 ac 11 80 00 	movsbl 0x8011ac(%eax),%eax
  8001c0:	50                   	push   %eax
  ...
  800293:	e8 98 0d 00 00       	call   801030 <__umoddi3>
  800298:	83 c4 14             	add    $0x14,%esp
  80029b:	0f be 80 ac 11 80 00 	movsbl 0x8011ac(%eax),%eax
  8002a2:	50                   	push   %eax
  ...
  8002c9:	e8 32 0c 00 00       	call   800f00 <__udivdi3>
  ...
  8002ef:	e8 3c 0d 00 00       	call   801030 <__umoddi3>
  8002f4:	83 c4 14             	add    $0x14,%esp
  8002f7:	0f be 80 ac 11 80 00 	movsbl 0x8011ac(%eax),%eax
  8002fe:	50                   	push   %eax
  ...
  800325:	e8 d6 0b 00 00       	call   800f00 <__udivdi3>
  ...
  80034b:	e8 e0 0c 00 00       	call   801030 <__umoddi3>
  800350:	83 c4 14             	add    $0x14,%esp
  800353:	0f be 80 ac 11 80 00 	movsbl 0x8011ac(%eax),%eax
  80035a:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80046e:	ff 24 85 b8 12 80 00 	jmp    *0x8012b8(,%eax,4)
  ...
  80054f:	83 f8 06             	cmp    $0x6,%eax
  800552:	7f 0b                	jg     80055f <vprintfmt+0x183>
  800554:	8b 14 85 10 14 80 00 	mov    0x801410(,%eax,4),%edx
  80055b:	85 d2                	test   %edx,%edx
  80055d:	75 15                	jne    800574 <vprintfmt+0x198>
				printfmt(putch, putdat, "error %d", err);
  80055f:	50                   	push   %eax
  800560:	68 c4 11 80 00       	push   $0x8011c4
  800565:	53                   	push   %ebx
  800566:	57                   	push   %edi
  ...
  800574:	52                   	push   %edx
  800575:	68 cd 11 80 00       	push   $0x8011cd
  80057a:	53                   	push   %ebx
  80057b:	57                   	push   %edi
  ...
  800596:	b9 bd 11 80 00       	mov    $0x8011bd,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  800812:	68 3c 12 80 00       	push   $0x80123c
  800817:	68 cd 11 80 00       	push   $0x8011cd
  ...
  800833:	68 74 12 80 00       	push   $0x801274
  800838:	68 cd 11 80 00       	push   $0x8011cd
...
00800dd8 <label_90>:
  ...
  800de9:	68 2c 14 80 00       	push   $0x80142c
  800dee:	6a 2a                	push   $0x2a
  800df0:	68 49 14 80 00       	push   $0x801449
  800df5:	e8 9d 00 00 00       	call   800e97 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e9c:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	if (argv0)
  800e9f:	a1 10 20 80 00       	mov    0x802010,%eax
  800ea4:	85 c0                	test   %eax,%eax
  800ea6:	74 11                	je     800eb9 <_panic+0x22>
		cprintf("%s: ", argv0);
  800ea8:	83 ec 08             	sub    $0x8,%esp
  800eab:	50                   	push   %eax
  800eac:	68 57 14 80 00       	push   $0x801457
  800eb1:	e8 83 f2 ff ff       	call   800139 <cprintf>
  800eb6:	83 c4 10             	add    $0x10,%esp
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800eb9:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800ebf:	e8 3d ff ff ff       	call   800e01 <sys_getenvid>
  800ec4:	83 ec 0c             	sub    $0xc,%esp
  800ec7:	ff 75 0c             	pushl  0xc(%ebp)
  800eca:	ff 75 08             	pushl  0x8(%ebp)
  800ecd:	56                   	push   %esi
  800ece:	50                   	push   %eax
  800ecf:	68 5c 14 80 00       	push   $0x80145c
  800ed4:	e8 60 f2 ff ff       	call   800139 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ed9:	83 c4 18             	add    $0x18,%esp
  800edc:	53                   	push   %ebx
  800edd:	ff 75 10             	pushl  0x10(%ebp)
  800ee0:	e8 03 f2 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800ee5:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  800eec:	e8 48 f2 ff ff       	call   800139 <cprintf>
  800ef1:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800ef4:	cc                   	int3   
  800ef5:	eb fd                	jmp    800ef4 <_panic+0x5d>
